...
.
├── notebooks/
│   ├── 1_RegressionImplementationBasics-1.ipynb
│   ├── 1_Multi-class-Classification-Example.ipynb
│   ├── DealingWithOverfittingExampleCodes-1-3.ipynb
│   ├── Part1_Playing_with_Optimizer_and_Leanring_Rate-2.ipynb
│   └── CNN_Example_-1-_-1-1-2.ipynb
├── data/
│   └── Salary_Data.csv
├── notes/
│   ├── Note-30-May-2026.pdf
│   ├── Note-31-May-2026.pdf
│   ├── Note-6-Jun-2026.pdf
│   ├── Note-13-Jun-2026.pdf
│   ├── Note-14-Jun-2026.pdf
│   ├── Note-20-Jun-2026.pdf
│   └── Note-27-Jun-2026.pdf
└── README.md
```

Adjust paths to match the actual GitHub repository layout.

## Recommended checklist

- [ ] Inspect data shape, types, missing values, and class balance.
- [ ] Separate features and labels correctly.
- [ ] Encode labels according to the problem type.
- [ ] Fit preprocessing on training data and reuse it at inference.
- [ ] Select output units, activation, and loss consistently.
- [ ] Start with a simple baseline model.
- [ ] Track training and validation metrics.
- [ ] Experiment with optimizer and learning rate.
- [ ] Apply regularization when generalization is weak.
- [ ] Save the model and preprocessing objects together.
- [ ] Test deployment code with representative inputs.
...
This repository follows a practical loop: understand the concept, implement it in Python, inspect the training behavior, experiment with alternatives, and document the result. The notebooks are learning artifacts, so future improvements may include cleaner pipelines, reproducible seeds, early stopping, stronger evaluation, model checkpoints, and deployment examples.

## Source material

This README was prepared from the uploaded learning notes and notebooks, including the ANN, regression, multiclass classification, optimizer, overfitting, CNN, and transfer-learning materials.